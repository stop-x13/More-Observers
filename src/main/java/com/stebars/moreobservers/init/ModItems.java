...
public class ModItems {
    ...
    public static final RegistryObject<BlockItem> DISCERNER_BLOCK = ITEMS.register("discerner", 
        () -> new BlockItem(ModBlocks.DISCERNER_BLOCK.get(), new Item.Properties().tab(CreativeModeTab.TAB_REDSTONE)));
    
    public static final RegistryObject<BlockItem> MOB_OBSERVER_BLOCK = ITEMS.register("mob_observer", 
        () -> new BlockItem(ModBlocks.MOB_OBSERVER_BLOCK.get(), new Item.Properties().tab(CreativeModeTab.TAB_REDSTONE)));

    public static final RegistryObject<BlockItem> SURVEYOR_BLOCK = ITEMS.register("surveyor", 
        () -> new BlockItem(ModBlocks.SURVEYOR_BLOCK.get(), new Item.Properties().tab(CreativeModeTab.TAB_REDSTONE)));

    public static final RegistryObject<BlockItem> TOGGLE_OBSERVER_BLOCK = ITEMS.register("toggle_observer", 
        () -> new BlockItem(ModBlocks.TOGGLE_OBSERVER_BLOCK.get(), new Item.Properties().tab(CreativeModeTab.TAB_REDSTONE)));
